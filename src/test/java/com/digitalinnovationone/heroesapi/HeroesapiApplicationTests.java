...
class HeroesapiApplicationTests {
	...
	public void getOneHeroeById(){
		...
		webTestClient.get().uri(HERDES_ENDPOINT_LOCAL.concat("/{id}"),"1215")
				.exchange()
				.expectStatus().isOk()
				.expectBody();
	...
	public void getOneHeronotFound(){
		...
		webTestClient.get().uri(HERDES_ENDPOINT_LOCAL.concat("/{id}"),"10")
				.exchange()
	...
	public void deleteHero(){
		...
		webTestClient.delete().uri(HERDES_ENDPOINT_LOCAL.concat("/{id}"),"1")
